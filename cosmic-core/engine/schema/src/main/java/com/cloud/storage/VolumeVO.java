...
public class VolumeVO implements Volume {
    ...
    public VolumeVO(final Type type, final String name, final long dcId, final long domainId,
                    ...
                    final long size, final String iScsiName, final DiskControllerType diskControllerType) {
    ...
    public VolumeVO(final String name, final long dcId, final Long podId, final long accountId,
                    final long domainId, final Long instanceId, final String folder, final String path,
                    final Storage.ProvisioningType provisioningType, final long size, final String iScsiName,
